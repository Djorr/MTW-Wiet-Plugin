...
public class PlantListener implements Listener {
    ...
    private boolean isNearDealer(org.bukkit.Location location) {
        int dealerDistance = nl.yourname.weedplugin.WeedPlugin.getPlugin(nl.yourname.weedplugin.WeedPlugin.class).getConfig().getInt("planting.dealer-distance", 10);
        
        for (net.citizensnpcs.api.npc.NPC npc : nl.yourname.weedplugin.manager.NPCManager.getInstance().getAllWeedNPCs().values()) {
